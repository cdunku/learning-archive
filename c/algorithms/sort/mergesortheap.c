#include <stdio.h>
#include <stdlib.h>
// NOTE: This implementation uses heap allocation (via malloc).
// This avoids stack overflow and is suitable for large arrays.
...
void divide_arr(int *arr, size_t l, size_t m, size_t r) {
  ...
  if(!arr1 || !arr2) {
    printf("The arrays have not been properly allocated\n");
  }
